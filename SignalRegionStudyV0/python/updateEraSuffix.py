...
if args.method == "shape":
    TEMPLATE_DIR = f"templates/{args.era}/{args.channel}/{args.masspoint}/Shape/Baseline"
elif args.method == "ParticleNet":
    TEMPLATE_DIR = f"templates/{args.era}/{args.channel}/{args.masspoint}/Shape/ParticleNet"
else:
    raise ValueError(f"Invalid method: {args.method}")

# BackUp the ROOT file
shutil.copy(f"{TEMPLATE_DIR}/shapes_input.root", f"{TEMPLATE_DIR}/shapes_input.root.bak")
...
original = ROOT.TFile.Open(f"{TEMPLATE_DIR}/shapes_input.root.bak")
