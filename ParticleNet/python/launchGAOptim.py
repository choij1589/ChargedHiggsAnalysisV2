...
gaModule.updatePopulation(args.signal, args.background, args.channel, read_from=f"{base_dir}/GA-iter0/CSV")
...
for i in range(1, args.maxIter):
    ...
    gaModule.updatePopulation(args.signal, args.background, args.channel, read_from=f"{base_dir}/GA-iter{i}/CSV")
